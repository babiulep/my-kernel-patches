...
- NVIDIA NEXT 610.57.04:  
  ...
  and remove drm_atomic_helper_crtc_reset
- NVIDIA: create NEXT patches
- NEXT: add patches
...
* TIP+NEXT:  
  ...
  binutils-dev installed or have binutils development files in an non-standard location
